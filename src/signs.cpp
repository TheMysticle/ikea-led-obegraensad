...
std::vector<font> fonts = {
    ...
    {"system", // name
     ...
     32,       // offset
     {
         ...
         {0x70, 0x88, 0x88, 0xF8, 0x88, 0x88, 0x98}, // 128 - Ą
         {0x00, 0x70, 0x08, 0x3C, 0x88, 0x78, 0x08}, // 129 - ą
         {0x10, 0x20, 0x70, 0x80, 0x80, 0x88, 0x70}, // 130 - Ć
         {0x00, 0x10, 0x20, 0x70, 0x80, 0x88, 0x70}, // 131 - ć
         {0x88, 0x70, 0x88, 0x88, 0xF8, 0x88, 0x88}, // 132 - Ä
         {0xF8, 0x80, 0x80, 0xF0, 0x80, 0xF0, 0x08}, // 133 - Ę
         {0x00, 0x70, 0x88, 0xF8, 0x80, 0x70, 0x08}, // 134 - ę
         {0x80, 0x80, 0x80, 0xC0, 0x80, 0x80, 0xF8}, // 135 - Ł
         {0x60, 0x20, 0x70, 0x20, 0x20, 0x20, 0x70}, // 136 - ł
         {0x10, 0x20, 0xC8, 0xA8, 0x98, 0x88, 0x88}, // 137 - Ń
         {0x00, 0x10, 0x20, 0xB0, 0xC8, 0x88, 0x88}, // 138 - ń
         {0x10, 0x20, 0x78, 0x80, 0x70, 0x08, 0xF0}, // 139 - Ś
         {0x00, 0x10, 0x20, 0x70, 0x80, 0x70, 0xF0}, // 140 - ś
         {0x10, 0x20, 0xF8, 0x10, 0x20, 0x40, 0xF8}, // 141 - Ź
         {0x00, 0x10, 0x20, 0xF8, 0x10, 0x40, 0xF8}, // 142 - ź
         {0x20, 0x00, 0xF8, 0x10, 0x20, 0x40, 0xF8}, // 143 - Ż
         {0x00, 0x20, 0x00, 0xF8, 0x20, 0x40, 0xF8}, // 144 - ż
         {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // 145
         {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // 146
         {0x10, 0x20, 0x70, 0x88, 0x88, 0x88, 0x70}, // 147 - Ó
         ...
         {0x00, 0x10, 0x20, 0x70, 0x88, 0x88, 0x70}, // 179 - ó
